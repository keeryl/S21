...
START_TEST(test_tan) {
  for (double x = -1100000; x < 1100000; x += 10505.333) {
    double tan_res = tan(x);
    long double s21_tan_res = s21_tan(x);
    ck_assert_ldouble_eq_tol((long double)tan_res, s21_tan_res, 1e-6);
  }
  for (double x = -10; x < 10; x += 0.333) {
    double tan_res = tan(x);
    long double s21_tan_res = s21_tan(x);
